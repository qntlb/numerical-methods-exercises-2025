 ...
 * Then we simply go forward setting B_{t_j}= B_{t_{j-1}} + ΔB_j.
 *
 */
public class BrownianMotion {
	...
	/**
	 * Creates an object of type Brownian motion
	 *
	...
	/**
	 * Generates a Brownian motion, i.e., it fills the entries of brownianPaths.
	...
	/**
	 * Gets and returns the one-dimensional array of random variables representing the brownian
	 * realized paths.
	 *
	...
	/**
	 * Gets and returns a random variable which represents the Brownian motion at a given time index
	 *
	...
	/**
	 * Gets and returns a random variable which represents the Brownian motion at a given time
	 *
	...
	/**
	 * Gets and returns a one-dimensional array of doubles representing the path of the
	...
	/**
	 * Gets and returns a double representing the realization of the Brownian
	...
	/**
	 * Prints a one-dimensional array of doubles representing the given path of
	...
	/**
	 * Plots the one-dimensional array of doubles representing the given path of
	 * the Brownian motion for the given simulation index.
	 *
	 * @param pathIndex, index for the path (i.e., the given simulation)
	 */
