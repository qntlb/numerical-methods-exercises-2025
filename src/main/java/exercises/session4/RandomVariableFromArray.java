...
/**
 * This class represents a random variable, seen as a collection of realizations.
 * Not to be confused with what we have seen in RandomVariable and RandomVariableInterface:
 * in that case, the object represented a specific distribution, with the possibility of getting
 * the density, the cdf, or generating realizations of a random variable with such a distribution.
 * In this case, instead, we take a pure Monte-Carlo approach and we neglect the
...
public class RandomVariableFromArray {
	...
	/*
	 * Stores the realizations of our random variable: this is the core of our
	 * class, as it is used in basically all the methods.
	 */
	private double[] realizations;

	/**
	 * Creates an object representing a random variable whose realizations are
	...
	/**
	 * Returns the realizations of the random variable represented by the object
	 * calling this method
	 *
	 * @return the realizations of the random variable, as a one-dimensional array of doubles
	 */
	...
	/**
	 * Returns a specific realization for a given simulation index
	 *
	...
	/**
	 * Returns the average of the realizations of the random variable, i.e., of
	...
	/**
	 * Returns the standard deviation of the realizations of the random variable,
	...
	/**
	 * Returns the omega-wise sum of the random variable calling the method with
	...
	/**
	 * Returns the sum of the random variable calling the method with a double
	...
	public RandomVariableFromArray add(double value) {
		 ...
		 * 2. Perform the operation with the double
		 * 3. Wrap again the result.
		 */
		return new RandomVariableFromArray(realizationsSum);
	}
	...
	/**
	 * Returns the omega-wise product of the random variable calling the method
	...
	/**
	 * Returns the product of the random variable calling the method with a
	...
	/**
	 * Returns the omega-wise difference of the random variable calling the
	...
	/**
	 * Returns the difference of the random variable calling the method and a
	...
	/**
	 * Returns the omega-wise ratio of the random variable calling the method
	 * with the one given as an argument
	 *
	...
	/**
	 * Returns the ratio of the random variable calling the method with a double
