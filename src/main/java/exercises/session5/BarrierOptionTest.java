...
public class BarrierOptionTest {
	...
	/**
	 * Computes and returns the analytic value of a barrier option with only lower barrier, for a Black-Scholes underlying 
	 * @param initialValue
	 * @param riskFreeRate
	 * @param volatility
	 ...
	 */
	public static double getAnalyticValueDownAdOut(
			double initialValue,
			double riskFreeRate,
			double volatility,
	...
	public static void main(String[] args) throws CalculationException {
		...
		final DecimalFormat formatterValue = new DecimalFormat(" ##0.0000");
		System.out.println("Monte Carlo price:\t" + formatterValue.format(monteCarloPrice));
		System.out.println("Analytic price:\t " + formatterValue.format(analyticPrice));
		System.out.println("Relative error:\t" + formatterValue.format(100 * (monteCarloPrice - analyticPrice) / analyticPrice));
