...
public class NormalRandomVariable extends RandomVariableAbstract {
	...
	/**
	 * Returns the value in a given point of the cumulative distribution function
	...
	/**
	 * Generates a pair of independent normal random variable by acceptance rejection
	 *
	 * @return array of doubles of length 2, containing the two realizations
	 */
	public double[] generateBivariateAR() { // generation
		// TODO implement the method
